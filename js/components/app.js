      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'col-md-6' },
            _react2.default.createElement('img', { src: '/img/bitcoin-logo.png', alt: 'bitcoin logo', className: 'bitcoin-logo' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'col-md-6' },
...
var Layout = function (_Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function checkProfits() {
      //https://min-api.cryptocompare.com/data/pricehistorical?fsym=ETH&tsyms=BTC,USD,EUR&ts=1509479065&extraParams=your_app_name
      var self = this;
      _axios2.default.get('https://min-api.cryptocompare.com/data/pricehistorical?fsym=ETH&tsyms=BTC,USD,EUR&ts=' + self.state.date.unix() + '&extraParams=your_app_name').then(function (response) {
        self.setState({
          data: response.data.ETH
        }, function () {
          // COST PRICE = 108.78
          // SELLING PRICE = 16467.91
          // GAIN = SP - CP
          // 16467.91 -108.78 = 16359.13
          // GAIN% = (GAIN / CP) * 100
          // (16539.13 / 108.78) * 100 = 15038.7229545872403015
          // LOSS = CP - SP
          // 108.78 - 16467.91 = -16359.13
          // LOSS% = (LOSS / CP)
          // (-16359.13 / 108.78) * 100 = -15038.
          console.log(self.state);
